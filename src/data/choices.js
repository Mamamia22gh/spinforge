...
export const CHOICES = [
  ...
  { id: 'add_star',      name: 'Étoile',          emoji: '⭐', description: 'Ajoute une Étoile (multi all)',      type: 'add_symbol',    weight: 2,  minRound: 7, requiresUnlock: 'unlock_star', payload: { symbolId: 'star' } },
