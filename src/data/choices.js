...
export const CHOICES = [
  ...
  { id: 'add_diamond',    name: 'Diamant',          emoji: '💎', description: 'Ajoute un Diamant (multi all)',      type: 'add_symbol',    weight: 2,  minRound: 7, requiresUnlock: 'unlock_diamond', payload: { symbolId: 'diamond' } },
  ...
  // ── Chip / spin upgrades ──
  { id: 'chips_10',       name: '+10 Chips',        emoji: '🪙', description: '+10 chips de base',                  type: 'upgrade',       weight: 8,  minRound: 1, requiresUnlock: null, payload: { chipsMax: 10 } },
  { id: 'chips_25',       name: '+25 Chips',        emoji: '🪙', description: '+25 chips de base',                  type: 'upgrade',       weight: 4,  minRound: 4, requiresUnlock: null, payload: { chipsMax: 25 } },
  { id: 'extra_spin',     name: '+1 Spin',          emoji: '🔄', description: '+1 spin par round',                  type: 'upgrade',       weight: 5,  minRound: 3, requiresUnlock: null, payload: { extraSpins: 1 } },
  { id: 'payout_10',      name: '+10% Payouts',     emoji: '📈', description: '+10% tous les payouts',              type: 'upgrade',       weight: 6,  minRound: 2, requiresUnlock: null, payload: { payoutPercent: 10 } },
  { id: 'payout_25',      name: '+25% Payouts',     emoji: '📈', description: '+25% tous les payouts',              type: 'upgrade',       weight: 3,  minRound: 5, requiresUnlock: null, payload: { payoutPercent: 25 } },
];
