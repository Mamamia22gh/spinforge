...
export const RELICS = [
  ...
  // ═══ UNCOMMON ═══
  { id: 'even_charm',     name: 'Charme Pair',        emoji: '✨', description: '+1 aux cases paires',                rarity: 'uncommon',  cost: 45,  minRound: 2, effects: [{ type: 'add_even_segments', value: 1, metaLevel: 0 }] },
  { id: 'odd_charm',      name: 'Charme Impair',      emoji: '✨', description: '+3 aux cases impaires',              rarity: 'uncommon',  cost: 50,  minRound: 2, effects: [{ type: 'add_odd_segments', value: 3, metaLevel: 0 }] },

  // ═══ RARE ═══
  { id: 'even_totem',     name: 'Totem Pair',         emoji: '🗿', description: '+5 aux cases paires',                rarity: 'rare',      cost: 80,  minRound: 4, effects: [{ type: 'add_even_segments', value: 5, metaLevel: 0 }] },
  { id: 'odd_totem',      name: 'Totem Impair',       emoji: '🗿', description: '+10 aux cases impaires',             rarity: 'rare',      cost: 90,  minRound: 4, effects: [{ type: 'add_odd_segments', value: 10, metaLevel: 0 }] },

  // ═══ LEGENDARY ═══
  { id: 'celestial_crown',name: 'Couronne Céleste',   emoji: '👑', description: '+25 pairs, +50 impairs',             rarity: 'legendary', cost: 200, minRound: 7, effects: [{ type: 'add_even_segments', value: 25, metaLevel: 0 }, { type: 'add_odd_segments', value: 50, metaLevel: 0 }] },
];
