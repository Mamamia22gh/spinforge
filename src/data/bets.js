...
export const BET_TYPES = [
  ...
  { id: 'exact_diamond',name: 'Exact Diamant', emoji: '💎', description: 'Le symbole Diamant exact',    payout: 10,  condition: 'exact',    target: 'diamond',startsUnlocked: false, minRound: 5 },
